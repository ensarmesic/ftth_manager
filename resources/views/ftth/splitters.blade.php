...
@section('subtitle', 'Pregled zauzeca splittera i raspolozivih portova po ODO ormaricu.')
...
<section class="mt-5 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-left text-sm">
            <thead class="bg-slate-50 text-xs uppercase text-slate-500"><tr><th class="px-4 py-3">ODO</th><th class="px-4 py-3">Projekat</th><th class="px-4 py-3">ODF</th><th class="px-4 py-3">Splitteri</th><th class="px-4 py-3">Kuce</th><th class="px-4 py-3">Portovi</th><th class="px-4 py-3">Zauzece</th></tr></thead>
            <tbody>
            ...
            @empty
                <tr><td colspan="7" class="px-4 py-8 text-center text-slate-500">Nema evidentiranih ODO ormarica.</td></tr>
            @endforelse
            </tbody>
        </table>
    </div>
