...
use App\Http\Controllers\LargePlannerConstraintController;
use App\Http\Controllers\LargePlannerCorridorController;
use App\Http\Controllers\LargePlannerHouseController;
use App\Http\Controllers\LargePlannerInputSnapshotController;
use App\Http\Controllers\LargePlannerInputValidationController;
use App\Http\Controllers\LargePlannerPreviewController;
use App\Http\Controllers\LargePlannerReadinessController;
use App\Http\Controllers\LargePlannerSettingController;
use App\Http\Controllers\LargePlannerZoneController;
...
Route::middleware('auth')->group(function (): void {
    ...
    Route::post('/projekti/{project}/veliki-planer/kuce', [LargePlannerHouseController::class, 'store'])->middleware('can:project.edit')->name('projects.large-planner.houses.store');
    Route::post('/projekti/{project}/veliki-planer/kuce/import', [LargePlannerHouseController::class, 'import'])->middleware(['can:project.edit', 'throttle:heavy'])->name('projects.large-planner.houses.import');
    Route::get('/projekti/{project}/veliki-planer/validacija-ulaza', LargePlannerInputValidationController::class)->middleware('can:project.view')->name('projects.large-planner.input-validation');
    Route::get('/projekti/{project}/veliki-planer/spremnost', LargePlannerReadinessController::class)->middleware('can:project.view')->name('projects.large-planner.readiness');
    Route::get('/projekti/{project}/veliki-planer/ulazne-revizije', [LargePlannerInputSnapshotController::class, 'index'])->middleware('can:project.view')->name('projects.large-planner.input-snapshots.index');
    Route::post('/projekti/{project}/veliki-planer/ulazne-revizije', [LargePlannerInputSnapshotController::class, 'store'])->middleware('can:project.edit')->name('projects.large-planner.input-snapshots.store');
    Route::get('/projekti/{project}/veliki-planer/zone', [LargePlannerZoneController::class, 'index'])->middleware('can:project.view')->name('projects.large-planner.zones.index');
    Route::post('/projekti/{project}/veliki-planer/zone', [LargePlannerZoneController::class, 'store'])->middleware('can:project.edit')->name('projects.large-planner.zones.store');
    Route::post('/projekti/{project}/veliki-planer/zone/automatska-podjela', [LargePlannerZoneController::class, 'autoSplit'])->middleware('can:project.edit')->name('projects.large-planner.zones.auto-split');
    Route::post('/projekti/{project}/veliki-planer/zone/pripremi-replan', [LargePlannerZoneController::class, 'prepareReplan'])->middleware('can:project.edit')->name('projects.large-planner.zones.prepare-replan');
    Route::patch('/projekti/{project}/veliki-planer/zone/{zone}', [LargePlannerZoneController::class, 'update'])->middleware('can:project.edit')->name('projects.large-planner.zones.update');
    Route::patch('/projekti/{project}/veliki-planer/zone/{zone}/status', [LargePlannerZoneController::class, 'updateStatus'])->middleware('can:project.edit')->name('projects.large-planner.zones.status');
    Route::post('/projekti/{project}/veliki-planer/zone/{zone}/kuce', [LargePlannerZoneController::class, 'assignHouses'])->middleware('can:project.edit')->name('projects.large-planner.zones.houses.assign');
    Route::delete('/projekti/{project}/veliki-planer/zone/{zone}', [LargePlannerZoneController::class, 'destroy'])->middleware('can:project.edit')->name('projects.large-planner.zones.destroy');
    Route::get('/projekti/{project}/veliki-planer/preview', [LargePlannerPreviewController::class, 'index'])->middleware('can:project.view')->name('projects.large-planner.preview.index');
