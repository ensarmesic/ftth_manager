...
<section class="grid gap-6 xl:grid-cols-[420px_1fr]">
    ...
    @include('ftth.partials.table', ['rows' => $routes, 'columns' => ['name' => 'Trasa', 'project.name' => 'Projekat', 'odf.name' => 'ODF', 'cabinet.name' => 'ODO', 'installation_type' => 'Polaganje', 'microduct_type' => 'Mikrocijev', 'duct_length_m' => 'Duzina m', 'fiber_count' => 'Niti', 'status' => 'Status'], 'deleteRoute' => fn($id) => route('routes.delete', $id)])
</section>
@endsection
