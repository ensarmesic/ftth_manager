...
<section class="grid gap-6 xl:grid-cols-[420px_1fr]">
    ...
    @include('ftth.partials.table', ['rows' => $projects, 'columns' => ['name' => 'Naziv', 'code' => 'Sifra', 'location' => 'Lokacija', 'investor' => 'Investitor', 'status' => 'Status'], 'deleteRoute' => fn($id) => route('projects.delete', $id)])
</section>
@endsection
