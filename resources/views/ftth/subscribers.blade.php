...
<section class="mb-5 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
    <article class="stat-card">
        <div class="flex items-start justify-between gap-3">
            <div>
                ...
                <div class="stat-value">{{ $subscriberStats['total'] }}</div>
            </div>
    ...
    <article class="stat-card">
        <div class="flex items-start justify-between gap-3">
            <div>
                <div class="stat-label">U servisu</div>
                <div class="stat-value">{{ $subscriberStats['in_service'] }}</div>
            </div>
    ...
    <article class="stat-card">
        <div class="flex items-start justify-between gap-3">
            <div>
                <div class="stat-label">Planirani</div>
                <div class="stat-value">{{ $subscriberStats['planned'] }}</div>
            </div>
    ...
    <article class="stat-card">
        <div class="flex items-start justify-between gap-3">
            <div>
                <div class="stat-label">Ormarići</div>
                <div class="stat-value">{{ $subscriberStats['cabinets'] }}</div>
            </div>
...
<section class="grid gap-6 xl:grid-cols-[420px_1fr]">
    <form method="POST" action="{{ route('subscribers.store') }}" class="page-form">
        @csrf
        ...
        <div class="page-form-body">
            ...
            <div id="capacity-warning" class="hidden info-banner red">
                ...
                <p class="font-medium">Odabrani ormarić je popunjen! Odaberi drugi ormarić ili planiraj novi.</p>
            </div>
