...
<section class="mb-5 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
    ...
    <article class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        <div class="text-sm text-slate-500">Zavrseni</div>
...
<section class="grid gap-6 xl:grid-cols-[420px_1fr]">
    ...
    @include('ftth.partials.table', ['rows' => $projects, 'columns' => ['name' => 'Naziv', 'code' => 'Sifra', 'location' => 'Lokacija', 'investor' => 'Investitor', 'status' => 'Status'], 'editRoute' => fn($id) => route('projects.update', $id), 'deleteRoute' => fn($id) => route('projects.delete', $id), 'editFields' => [
        'name' => 'Naziv', 'code' => 'Sifra', 'location' => 'Lokacija', 'investor' => 'Investitor',
        'status' => ['label' => 'Status', 'type' => 'select', 'options' => ['planning' => 'Planiranje', 'active' => 'Aktivan', 'paused' => 'Pauziran', 'completed' => 'Zavrsen']],
        'start_date' => ['label' => 'Pocetak', 'type' => 'date'], 'deadline' => ['label' => 'Rok', 'type' => 'date'], 'description' => 'Opis',
    ]])
</section>
@endsection
