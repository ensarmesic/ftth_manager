{{-- DXF floating panel --}}
<div id="dxf-layer-panel" class="floating-tool-panel floating-tool-panel-compact">
    <div class="floating-tool-header floating-tool-header-indigo">
        <span>DXF Layeri</span>
        <button type="button" id="dxf-layer-close" class="floating-tool-close" aria-label="Zatvori DXF panel">&times;</button>
    </div>
