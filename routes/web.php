...
Route::middleware('auth')->group(function (): void {
    ...
    Route::get('/projekti/{project}/fiber-plan/csv', [FiberManagementController::class, 'csv'])->name('projects.fiber.csv');
    Route::post('/projekti/{project}/fiber-splice', [FiberManagementController::class, 'storeSplice'])->name('projects.fiber.splice.store');
    Route::delete('/projekti/{project}/fiber-splice/{splice}', [FiberManagementController::class, 'destroySplice'])->name('projects.fiber.splice.destroy');
    Route::get('/projekti/{project}/fiber-verzije', [FiberManagementController::class, 'versions'])->name('projects.fiber.versions');
    Route::post('/projekti/{project}/fiber-verzije', [FiberManagementController::class, 'storeVersion'])->name('projects.fiber.versions.store');
